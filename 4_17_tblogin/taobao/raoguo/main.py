...
from taobao.raoguo.alifunc import mouse_slide, input_time_random

from taobao.raoguo.exe_js import js1, js3, js4, js5, js6aob


async def main(username, pwd, url):
    browser = await launch({'headless': False, 'args':['--no-sandbox','--proxy-server=http://127.0.0.1:8080'], })
